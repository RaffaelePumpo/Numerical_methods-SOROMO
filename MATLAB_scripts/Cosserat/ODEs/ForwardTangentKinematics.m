...
eta_prime     = - ad(Xi)*eta + dot_Xi;
dot_eta_prime = - ad(Xi)*dot_eta - ad(dot_Xi)*eta + ddot_Xi;

Delta_zeta_prime    = - ad(Xi)*Delta_zeta + Delta_Xi;  
Delta_eta_prime     = - ad(Xi)*Delta_eta + ad(eta)*Delta_Xi + Delta_dot_Xi;  
Delta_dot_eta_prime = - ad(Xi)*Delta_dot_eta - ad(dot_Xi)*Delta_eta ...
                      + ad(eta)*Delta_dot_Xi + ad(dot_eta)*Delta_Xi + Delta_ddot_Xi;  
