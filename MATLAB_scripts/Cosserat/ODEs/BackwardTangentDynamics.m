...
dydx_tangent_kinematics = ForwardTangentKinematics(X, y, q, dot_q, ddot_q,...
                                                   ...
                                                   Config, Const);
Lambda_prime            = ad(Xi)'*Lambda + M*dot_eta - ad(eta)'*M*eta - F_bar;
Delta_Lambda_prime      = M*Delta_dot_eta - ad(eta)'*M*Delta_eta - ad(Delta_eta)'*M*eta ...
                            + ad(Xi)'*Delta_Lambda + ad(Delta_Xi)'*Lambda - Delta_F_bar;
